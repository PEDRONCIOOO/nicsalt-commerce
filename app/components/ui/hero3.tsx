            ...
            >
              {filteredProducts.length > 0 ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2">Nenhum produto encontrado.</h3>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="flex flex-col justify-between">
                      <div>
                        <motion.div variants={modalItemVariants} className="flex justify-between items-start mb-1">
                          <div>
                            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">{selectedProduct.name}</h2>
                        ...
                        <motion.div 
                          ...
                          variants={modalItemVariants}
                        >
                          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Descrição</h3>
                          <p className="text-gray-600 dark:text-gray-400 mb-4">
                            {selectedProduct.description}
                          </p>
                        </motion.div>

                        <motion.div className="grid grid-cols-2 gap-4 mt-4" variants={modalItemVariants}>
                          {selectedProduct.nicotineStrength && (
                            <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
                              <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400">Nível de Nicotina</h4>
                              <p className="text-gray-800 dark:text-gray-200 font-semibold">{selectedProduct.nicotineStrength} mg</p>
                            </div>
                          )}
                          ...
                          {selectedProduct.volume && (
                            <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
                              ...
                              <p className="text-gray-800 dark:text-gray-200 font-semibold">{selectedProduct.volume} ml</p>
                            </div>
                          )}
                        </motion.div>

                        {selectedProduct.flavors && selectedProduct.flavors.length > 0 && (
                          <motion.div className="mt-4" variants={modalItemVariants}>
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Sabores</h3>
                        ...
                        {selectedProduct.colors && selectedProduct.colors.length > 0 && (
                          <motion.div className="mt-4" variants={modalItemVariants}>
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Cores Disponíveis</h3>
                            <div className="flex flex-wrap gap-2">
                  ...
                  <motion.div 
                    ...
                    variants={modalItemVariants}
                  >
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Informações Adicionais</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">ID do Produto</h4>
                        <p className="text-gray-800 dark:text-gray-200">{selectedProduct.id}</p>
                      </div>
                      <div>
                        <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Disponibilidade</h4>
